namespace FabricDeploymentManager.Models {
  ...
  public class StagingEnvironments {
    ...
    public static DeploymentPlan Dev {
      get {
        var Deployment = new DeploymentPlan("Dev", "Dev", DeploymentPlanType.StagedDeployment);
    ...
    public static DeploymentPlan Test {
      get {
        var Deployment = new DeploymentPlan("Test", "Test", DeploymentPlanType.StagedDeployment);
    ...
    public static DeploymentPlan Prod {
      get {
        var Deployment = new DeploymentPlan("Prod", "Prod", DeploymentPlanType.StagedDeployment);
